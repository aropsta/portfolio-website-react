...
let quotes = [
  ...
  },
  {
    title: "my weakness",
    content:
      "A perfectionist attitute toward things. Can slow down my progress",
  },
  {
    title: "my strength",
    content:
  ...
  },
  {
    title: "strawberries",
    content:
      "I used to think it was the most overrated fruit. That title now belongs to cherries",
  },
  {
    title: "myself",
    content:
    ...
    <>
      ...
      <section className="introduction-section section">
        ...
        <div className="divider">
          <section className="text-block card blur">
            ...
            <p>
              UI designer skilled in optimizing work processes to enhance user
              experiences and deliver products that are simple and easy to use
            </p>
          </section>
          ...
          <section className="text-block card blur">
            ...
            <p>
              Coder who has a keen interest for optimization and performance.
              Experienced in WCAG 2.1 with responsiveness and accessibility
              always in mind
            </p>
          </section>
          ...
          <section className="text-block card blur">
            ...
            <p>
              Able to operate autonomously and take initiative when most
              practical. Always within the scope of project outcomes
            </p>
          </section>
          ...
          <section className="text-block card blur">
            ...
            <p>
              I am capable team member, with proven leadership skills in
              academic roles. Experienced in utilizing collaborative tools git
              and figma jam
            </p>
          </section>
        </div>
        ...
        <section className="technical">
          ...
          <ul>
            {logos.map((item, i) => (
              <li className="logos" key={i}>
                <img src={item.src} alt={item.title} />
              </li>
            ))}
            <li className="skill">SASS</li>
            <li className="skill">React Hook Forms</li>
      ...
      <section className="about-me section">
        ...
        <section className="description">
          {getImg("top")}
          <p>
            There has always been so much that I want to express. But have been
            limited through my lack of knowledge and skills.
            <br />
            <br />
            From a young age this had led me persue those things that would help
            me build myself and better express myself.
            <br />
            <br />
            From coding to drawing, playing and creating music, and even math
            and science. If it can be used to express I will always be
            interested,
            <br />
          </p>
          {getImg("bottom")}
        ...
        <section className="functional">
          ...
          <p className="">
            <b>Clear communicative ability</b>—Demonstrated in group projects
            and previous roles
          </p>
          <p>
            <b>Adaptive Learner</b>—Proven by initiative and drive shown in
            academic career
          </p>
          <p>
            <b>Strong problem-solving</b> capability—gained from technical and
            math related units
          </p>
          <p>
            Ability to <b>effectively conceptualize</b> and materialize thoughts
            and idea’s
          </p>
        </section>
      ...
      <section className="my-work section" id="work">
        ...
        <ul>
          <li className="xac">
            <a
              className="link"
              aria-label="Go to Issue tracker repo"
              href="https://github.com/aropsta/issue-tracker"
              rel="noopener noreferrer"
              target="_black"
            >
              Issue tracker - A fullstack web app
            </a>
            <a
          ...
          <li className="xac">
            <a
              className="link"
              aria-label="Go to Game Hub repo"
              href="https://github.com/aropsta/game-library"
              rel="noopener noreferrer"
              target="_black"
            >
              Game Hub Library - RAWG API implemntation
            </a>
            <a
